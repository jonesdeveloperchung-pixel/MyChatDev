...
LLM_CONFIGS_OPTIMIZED: Dict[str, LLMConfig] = {
    "product_manager": LLMConfig(
        name="Product Manager",
    ...
    "programmer": LLMConfig(
        name="Programmer",
        model_id="gpt-oss:20b",  # broad coding/generalist
        role="programmer",
        temperature=0.1,
    ),
    "tester": LLMConfig(
        name="Tester",
        model_id="mistral:7b",   # lightweight, fast iteration
        role="tester",
        temperature=0.25,
    ),
    "reviewer": LLMConfig(
        name="Code Reviewer",
        model_id="llama3.2:3b",  # smaller but precise, good for review
        role="reviewer",
        temperature=0.2,
    ),
}
...
AVAILABLE_LLMS_BY_PROFILE: Dict[str, Dict[str, LLMConfig]] = {
    ...
    "optimized": LLM_CONFIGS_OPTIMIZED,  # default
